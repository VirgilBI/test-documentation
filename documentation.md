...
## Property_hs_closed_amount Field Format Change
Prior to 2022, the field property_hs_closed_amount represented an annual amount. After 2022, it represents a monthly revenue amount. When querying this field, data prior to 2022 should be excluded.
